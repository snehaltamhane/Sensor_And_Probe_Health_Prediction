# Sensor_And_Probe_Health_Prediction
...
> Repository for predicting failure or callibration time for sensors and probes in 3DT

This project is about predicting time to callibrate or failure of a probe
